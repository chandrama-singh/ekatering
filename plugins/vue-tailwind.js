...
const settings = {
    ...
    't-datepicker': {
        ...
        props: {
            ...
            classes: {
                ...
                otherMonthDay: 'text-sm rounded-full w-8 h-8 mx-auto hover:bg-green-100 text-gray-400 disabled:opacity-50 disabled:cursor-not-allowed',
                emptyDay: '',
                inRangeFirstDay: 'text-sm bg-green-500 text-white w-full h-8 rounded-l-full',
                inRangeLastDay: 'text-sm bg-green-500 text-white w-full h-8 rounded-r-full',
                inRangeDay: 'text-sm bg-green-200 w-full h-8 disabled:opacity-50 disabled:cursor-not-allowed',
                selectedDay: 'text-sm rounded-full w-8 h-8 mx-auto bg-green-500 text-white disabled:opacity-50 disabled:cursor-not-allowed',
                activeDay: 'text-sm rounded-full bg-green-100 w-8 h-8 mx-auto disabled:opacity-50 disabled:cursor-not-allowed',
                highlightedDay: 'text-sm rounded-full bg-green-200 w-8 h-8 mx-auto disabled:opacity-50 disabled:cursor-not-allowed',
                day: 'text-sm rounded-full w-8 h-8 mx-auto hover:bg-green-100 disabled:opacity-50 disabled:cursor-not-allowed',
                today: 'text-sm rounded-full w-8 h-8 mx-auto hover:bg-green-100 disabled:opacity-50 disabled:cursor-not-allowed border border-blue-500',
                monthWrapper: 'px-3 pt-2',
                selectedMonth: 'text-sm rounded w-full h-12 mx-auto bg-green-500 text-white',
                activeMonth: 'text-sm rounded w-full h-12 mx-auto bg-green-100',
                month: 'text-sm rounded w-full h-12 mx-auto hover:bg-green-100',
                yearWrapper: 'px-3 pt-2',
                year: 'text-sm rounded w-full h-12 mx-auto hover:bg-green-100',
                selectedYear: 'text-sm rounded w-full h-12 mx-auto bg-green-500 text-white',
                activeYear: 'text-sm rounded w-full h-12 mx-auto bg-green-100'
            },
            variants: {
                danger: {
    ...
    't-toggle': {
        ...
        props: {
            ...
            classes: {
                ...
                buttonChecked: 'h-5 w-5 rounded-full bg-white shadow flex items-center justify-center text-green-500 text-xs',
            ...
            variants: {
                ...
                box: {
                    ...
                    wrapperChecked: 'bg-green-500 rounded-sm',
                    wrapperCheckedDisabled: 'bg-green-500 rounded-sm',
                    button: 'h-6 w-6 rounded-sm bg-white shadow flex items-center justify-center text-gray-400 text-xs',
                    buttonChecked: 'h-6 w-6 rounded-sm  bg-white shadow flex items-center justify-center text-green-500 text-xs',
    ...
    't-alert': {
        ...
        props: {
            ...
            classes: {
                wrapper: 'bg-green-50 border-blue-500',
                body: 'text-green-700',
    ...
    't-dialog': {
        ...
        props: {
            ...
            classes: {
                ...
                okButton: 'bg-green-500 hover:bg-green-600',
                ...
                radio: 'text-green-500 transition duration-100 ease-in-out border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 focus:ring-offset-0  disabled:opacity-50 disabled:cursor-not-allowed',
                radioText: '',
                checkboxWrapper: 'flex items-center space-x-2',
                checkbox: 'text-green-500 transition duration-100 ease-in-out border-gray-300 rounded shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 focus:ring-offset-0  disabled:opacity-50 disabled:cursor-not-allowed',
                checkboxText: '',
    ...
    't-pagination': {
        ...
        props: {
            classes: {
                ...
                activeButton: 'bg-green-500 w-full h-full text-white hover:bg-green-600 transition duration-100 ease-in-out focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50',
                disabledButton: 'opacity-25 w-full h-full cursor-not-allowed transition duration-100 ease-in-out',
                button: 'hover:bg-green-100 w-full h-full transition duration-100 ease-in-out focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50',
                ellipsis: ''
            },
            variants: {
                rounded: {
                    ...
                    activeButton: 'border border-blue-500 bg-green-500 w-full h-full rounded-full text-white hover:bg-green-600 transition duration-100 ease-in-out focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50',
                    ...
                    button: 'border border-gray-200 hover:bg-green-100 hover:border-blue-100 rounded-full w-full h-full transition duration-100 ease-in-out focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50',
                    ellipsis: ''
                }
            }
        }
