  ...
  <div id="demo" :class="[{'collapsed' : collapsed}, {'onmobile' : isOnMobile}]">
    ...
    <div class="demo mr-0 mr-md-3" @click="menuClose">
      ...
      <transition name="slide-fade">
        <sidebar-menu :menu="menu" :collapsed="collapsed" :theme="selectedTheme" width="280px" :show-one-child="true"
          v-show="show" @toggle-collapse="onToggleCollapse" :hideToggle="true" @item-click="onItemClick"
          class="transition duration-500 ease-in-out">
          <template v-slot:header>
            <button class="h-16 flex items-center focus:outline-none bg-menuBlack hover:bg-black"
              :class="{'w-full': !collapsed, 'justify-end': !collapsed, 'justify-center': collapsed,}"
              ...
              <svg class="w-6 h-6 mr-4" fill="none" stroke="white" viewBox="0 0 24 24"
