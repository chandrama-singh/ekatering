  ...
  <section>
    <div class="container mx-auto px-4 bottom-0 p-4 mt-6">
      ...
      <p class="text-gray-400 leading-relaxed">
        A documented Food Safety Management System (FSMS) is a systematic approach to controlling food safety hazards within a food business to ensure that food is safe to
        eat. All businesses are required to put in place, implement and maintain
        a documented FSMS based on the principles of "Hazard Analysis Critical
        Control Point" (HACCP).<br />
        <span class="underline font-bold"
          >This is a legal requirement for all food businesses.</span
        >
      </p>
    </div>
    <!------------------------------------------------------------------------------------------------------>
    <div class="container mx-auto px-4 bottom-0 p-4">
      <h2 class="text-3xl mb-1 font-semibold font-heading">What is HACCP?</h2>
      <p class="text-gray-400 leading-relaxed">
        HACCP is a management system in which food safety is addressed by
        analysing and controlling biological, chemical, and physical hazards
    ...
    <section class="py-4 px-2">
      <div class="w-full max-w-5xl mx-auto text-center">
        ...
        <!-- <span class="text-sm">If you are a Home/Event Caterer or a Private Chef, help us kickstart your digital journey.</span><br/> -->
        <Nuxt-Link to="/visit-full-haccp-form">
          <button
            class="
              inline-block
              mt-6
