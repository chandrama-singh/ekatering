<template>
  <section class="relative pt-20 pb-5 2xl:pb-40 overflow-hidden bgabout border-2 border-red-500">
        ...
        <div class="w-full lg:w-3/5  lg:mb-0">
          <div class="max-w-7xl">
            ...
            <p class="ml-6 max-w-6xl text-gray-900 text-justify font-poppins leading-7 tracking-wide">
              ...
              interesting, and authentic food prepared in a kitchen that
              compiles with food safety regulations. Homeworking customers can
              also support their community financially by using local home
              catering businesses.
            </p>
            <br/>
            <p class="ml-6 text-gray-900 text-justify font-poppins leading-7 tracking-wide">
              ...
              expenses of running a takeaway or restaurant. Home/Event caterers
