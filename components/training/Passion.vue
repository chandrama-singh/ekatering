<template>
   <section class="py-12 px-4">
        <div class="w-full max-w-5xl mx-auto text-center border rounded-lg px-2 py-12 bg-purple-300">
          ...
          <Nuxt-Link to="/plans"><button class="inline-block mt-6  py-4 px-8 leading-none text-white bg-purple-600 hover:bg-purple-700 font-semibold rounded md:rounded-lg">Join Us</button></Nuxt-Link>
        </div>
      </section>
</template>
