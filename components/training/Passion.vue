...
TURN YOUR PASSION INTO CASH
          ...
          <Nuxt-Link to="/signin"><button class="inline-block mt-6  py-4 px-8 leading-none text-white bg-purple-600 hover:bg-purple-700 font-semibold rounded md:rounded-lg">Join Us</button></Nuxt-Link>
        </div>
      </section>
</template>
