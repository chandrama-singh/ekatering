  ...
  <section>
    <div class="container mx-auto px-4 bottom-0 p-4">
      ...
      <p class="mb-4 text-gray-400 leading-relaxed">
        ...
        train with us because the courses have been specifically tailored for
        you by professional eKatering staff with a wealth of experience in the
      ...
      <div class="flex">
        <ul class="ml-6 text-gray-400 text-justify list-disc">
          ...
          <li>
            To ensure you understand your legal requirements and comply with
            current food safety regulations.
          </li>
          <li>
            Ensure everything is in place before your food safety officer visits
            your food business.
          </li>
          <li>
          ...
          <li>
            Unlimited free retakes for <b>1 month</b> from the purchase date.
          </li>
