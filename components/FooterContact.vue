<template>
        ...
        <div class="flex items-right py-32">
        ...
        <div class="w-full lg:w-3/5 mb-16 lg:mb-0 pl-16">
          <div class="max-w-6xl ">
            ...
            <div class="px-2"><Nuxt-Link to="/plans" class="block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs text-purple-900 text-center font-semibold leading-none bg-white rounded">Get Started</Nuxt-Link></div>
          </div>
        </div>
        <div class="relative lg:w-2/5">
          <img
          class="lg:absolute top-0 right-0   lg:h-100 object-cover "
