<template>
  <section class="relative overflow-hidden">
        ...
        <div class="relative container px-4 mx-auto mt-2 ">
          <div class="max-w-5xl mx-auto">
            <div class="flex flex-wrap -mx-4 py-20 2xl:py-40">
              <div class="w-full lg:w-2/5 px-4 mb-8 lg:mb-0">
                <span class="text-lg font-bold text-purple-500">Contact with us</span>
                <!-- <h2 class="mt-8 mb-10 md:mb-10 text-4xl font-bold font-heading">Our Office in Varanasi</h2> -->
                <div class="flex py-6 border-b border-gray-50">
                  <span class="flex items-center justify-center w-12 h-12 mr-8 bg-purple-500 rounded-lg">
                  ...
                  <p class="text-md font-bold pt-2">+44 20457523 00 01</p>
                </div>
                <div class="flex items-center py-6 border-b border-gray-50">
                  ...
                  <p class="text-md font-bold">support@shuffle.dev</p>
                </div>
                <div class="flex items-center py-6">
                  <span class="flex flex-shrink-0 items-center justify-center w-12 h-12 mr-8 bg-purple-500 rounded-lg">
                  ...
                  <div>
                    <p class="mb-3 text-lg font-bold">Bayswater, London W16EG, UK</p>
                    <p class="text-gray-800">The one est bad, semper six at sem quis, congue 8 AM - 8 PM</p>
                  </div>
                </div>
              </div>
                ...
                <div class="lg:ml-20 px-8 lg:px-12 py-16 w-full lg:max-w-md bg-white shadow-lg rounded-lg">
                  <form action="#">
                    ...
                    <div class="text-right">
                      <button class="py-4 px-12 text-white font-bold bg-purple-500 hover:bg-purple-600 rounded-full transition duration-200">Send</button>
                    </div>
                  </form>
                </div>
              </div>
