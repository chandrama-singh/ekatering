  ...
  <section>
    <div class="container mx-auto px-4 bottom-0 p-4 mt-6">
      ...
      <p class=" text-gray-400 leading-relaxed">
        Before you can trade as a home/event caterer or a private chef, you must register with your local authority. Ideally, this should be done at least 28 days before trading. If you have already started trading without registering, you must do so as soon as possible.
      </p>
    </div>
    ...
    <div class="container mx-auto px-4 bottom-0 p-4 mt-3">
      ...
      <p class=" text-gray-400 leading-relaxed">
        You will need to register your home/event and private chef catering business if you:
      </p>
      <div class="flex">
