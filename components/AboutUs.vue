...
<section class="overflow-hidden lg:py-0 sm:py-20">
        <div class="container px-4 mx-auto py-4 lg:py-20 sm:py-20 flex flex-wrap">
          <div class=" pt-4 lg:pt-16 pl-4 text-left ">
            ...
            <div><nuxt-link class="block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center  leading-none bg-purple-600 hover:bg-purple-700 rounded" to="/plans">Get Started</nuxt-link></div>
          </div>
