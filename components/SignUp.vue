<template>
  <section>
      <div class="flex min-h-screen bg-white">
        ...
        <div class="md:w-1/2 max-w-lg mx-auto my-24 px-4 py-5 shadow border">
            ...
            <nuxt-link to="/signin" class="" data-test="Link"><span class="block  p-5 text-center text-gray-800  text-xs ">Already have an account?</span></nuxt-link>
        </div>
