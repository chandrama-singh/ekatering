        ...
        <div class="lg:w-4/6 px-4">
          <div class="flex flex-wrap -mx-4">
            <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-16 lg:mb-0">
              <h2 class="mb-4 text-white hover:text-gray-100">Discover</h2>
              <hr class="mb-3" />
              <ul class="text-md">
                <li class="mb-2">
                  <nuxt-link class="text-white hover:text-gray-100" to="/"
                    >Home</nuxt-link
                  >
                </li>
                <li class="mb-2">
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-16 lg:mb-0">
              <h2 class="mb-4 text-white hover:text-gray-100">Support</h2>
              <hr class="mb-3" />
              <ul class="text-md">
                <li class="mb-2">
                  <nuxt-link to="/faq" class="text-white hover:text-gray-100"
                    >FAQs</nuxt-link
                  >
                </li>
                <li class="mb-2">
            ...
            <div class="w-full lg:w-1/3 px-4">
              <h2 class="mb-4 text-gray-200 hover:text-gray-100">Contact</h2>
              <hr />
              ...
              <div class="flex items-center mt-4 text-white">
                ...
                <p class="ml-4 w-48">(+44) 1708 522 127</p>
              </div>
              ...
              <div class="flex items-center mt-2 text-white">
                ...
                <p class="ml-4 w-48">hello@ekatering.co.uk</p>
              </div>
            </div>
          </div>
        </div>
