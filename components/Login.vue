  	...
  	<div class="max-w-md w-full space-y-8  p-10 bg-white rounded-xl z-10">
		...
		<form class="mt-8 space-y-6" action="#" method="POST">
			...
			<div class="flex items-center justify-between">
				...
				<div class="text-sm">
					<Nuxt-Link to="/forgot" class="font-medium text-indigo-500 hover:text-indigo-500">
			...
			<p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
				...
				<Nuxt-Link to="/signup" class="text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign up</Nuxt-Link>
			</p>
