        ...
        <div class="container px-4 mx-auto">
          <nav class="flex items-center py-4">
            ...
            <ul class="hidden lg:flex items-center space-x-12 ml-auto mr-12">
              <li><nuxt-link to="/" class="text-md text-purple-600 hover:text-purple-900" >Home</nuxt-link></li>
              <li><nuxt-link to="/about" class="text-md text-purple-600 hover:text-purple-900" >About</nuxt-link></li>
