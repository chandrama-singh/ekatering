<template>
  <div v-if="user">
    ...
    <div
      style="background-color: #2a2a2e; width: 19rem"
      class="
        absolute
        right-2
        mt-2
    ...
    >
      <div class="py-2">
        <a
          href="#"
          class="flex flex-col items-center px-4 py-2 border-b border-black"
        >
          <div
            class="
              my-4
        ...
        <div>
            ...
            py-2
            border-b border-black
            hover:bg-purple-500"><i class="fas fa-graduation-cap text-lg mr-4"></i>My Training</Nuxt-Link>
        </div>

        

        <div
          class="flex items-center px-4 py-2 hover:bg-purple-500"
          @click="logout"
        >
