       ...
       <div class="flex items-center justify-center min-h-screen bg-blue-50">
            <div class="w-3/5 bg-white shadow-lg">
                <div class="flex justify-between p-4">
                    <div>
                        <h1 class="text-3xl italic font-extrabold tracking-widest text-indigo-500">eKatering</h1>
                        <p class="text-base">A one-stop-online shop for your home/event and private chef business.</p>
                    </div>
                    <div class="p-2">
                        <ul class="flex">
                            ...
                            <li class="flex flex-col p-2 border-l-2 border-indigo-200">
                                ...
                                <span class="text-sm">
                                    eKatering Limited PO Box, 370, Rainham, RM13 OED
                                </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="flex justify-between p-4">
                    ...
                    <div class="w-40">
                        <address class="text-sm">
                            <span class="font-bold">Bill By :</span>
                            Joe doe
                            800 Folsom Ave
                            San Francisco, CA 94107
                            P: + 111-456-7890
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center justify-center space-x-3 py-4">
                        <button class="px-4 py-2 text-sm text-white bg-green-500">Print</button>
                        <button class="px-4 py-2 text-sm text-white bg-blue-500">Save</button>
                        <button @click.stop.prevent="GoBack()" class="px-4 py-2 text-sm text-white bg-red-500">Cancel</button>
                    </div>
                </div>
...
export default {
    ...
    methods:{
        GoBack(){
            this.$router.push("/admin/training-orders");
        }
    }
}
</script>
