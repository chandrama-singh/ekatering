      ...
      <div class="w-3/5 bg-white shadow-lg">
        <div class="flex justify-between p-4">
          <div>
            ...
            <p class="text-base">
              A one-stop-online shop for your home/event and private chef
              business.
            </p>
          </div>
          <div class="p-2">
            <ul class="flex">
              ...
              >
                ...
                <span class="text-sm"> www.ekatering.com/ </span>
                <span class="text-sm"> www.ekatering.co.uk/ </span>
              </li>
          ...
          <div class="border-b border-gray-200 shadow">
            <table class="">
              <thead class="bg-gray-50">
                <tr>
                  <th class="px-4 py-2 text-xs text-gray-500">Product ID</th>
              ...
              <tbody class="bg-white">
                ...
                <tr class="text-white bg-gray-800">
                  ...
                  <td class="text-sm font-bold"><b>£30.0</b></td>
                </tr>
                <!--end tr-->
              </tbody>
            </table>
        ...
        <div class="p-4">
          ...
          <div class="flex items-center justify-center space-x-3 py-4">
            <button class="px-4 py-2 text-sm text-white bg-green-500">
              Print
            </button>
            <button class="px-4 py-2 text-sm text-white bg-blue-500">
              Save
            </button>
            <button
