...
<tr>
      ...
      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
        23/10 wall strret, dummy place, UK
      </td>
    </tr>
...
<table class="min-w-full leading-normal">
  <tbody>
    <tr>
      ...
      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
        <img
                          class="w-30 rounded-lg h-12 mr-4 object-cover"
...
<tr>
    ...
    <tr>
      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm font-bold">
       Local Authority Food Registration Letter
      </td>
      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
    ...
    <tr>
      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm font-bold">
       Food Hygiene Rating Scheme (FHRS) award letter
      </td>
      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
        <div class="w-full flex flex-col mb-3">
    ...
    <tr>
      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm font-bold">
       FHRS Next Inspection Due Date (call your local authority to get this date):
      </td>
      <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
        12/07/2030
      </td>
